...
//			return _SpawnGameObject(assetName, parent, pos, rot, scale,
//									type, location, activeEnable, bundleName ?? assetName);
//		}
...
//										 bool activeEnable = true,
//										 string bundleName = null) {
//			_SpawnGameObjectAsync(assetName, onAfter, parent, pos, rot, scale,
//								  type, location, activeEnable, bundleName ?? assetName);
//		}
...
//		/// <param name="type"> 애셋 타입, 프리팹 또는 오디오 클립 </param>
//		public void PrespawnObject(string assetName, int count = 1,
//									AssetType type = AssetType.Prefab,
//									AssetLocation location = AssetLocation.Default) {
//			_PrespawnObject(assetName, count, Vector3.zero, null, null, type, location);
//		}

//		public void PrespawnObjectAsync(string assetName, int count = 1,
//										Action<bool> onAfter = null,
//										AssetType type = AssetType.Prefab,
//										AssetLocation location = AssetLocation.Default) {
//			_PrespawnObjectAsync(assetName, count, onAfter, Vector3.zero, null, null, type, location);
//		}
...
//				success = suc;
//				loaded = true;
//			}, Vector3.zero, null, null, type, location);
...
//			Object asset = CreateAsset(assetName, location, bundleName);
//			if (asset == null)
//				return null;
...
//		public Object SpawnAsset(string assetName, AssetLocation location = AssetLocation.Default, string bundleName = null) {
//			// TryGetValue는 ContainsKey()로 찾은 값을 반환한다. 자주 사용하자
//			if (m_DicAsset.TryGetValue(assetName, out Object asset))
//				return asset;

//			asset = CreateAsset(assetName, location, bundleName);
//			if (asset != null) {
...
//									AssetLocation location = AssetLocation.Default, string bundleName = null) {
//			if (m_DicAsset.TryGetValue(assetName, out Object asset)) {
...
//			}, location, bundleName ?? assetName);
//		}

//		/// <summary> 개별적으로 관리할 애셋을 생성하는 함수 </summary>
//		public Object CreateAsset(string assetName, AssetLocation location = AssetLocation.Default, string bundleName = null) {
//			Object asset = AssetMgr.inst.GetAsset(assetName, location, bundleName);
//			if (asset == null)
...
//			AssetMgr.inst.GetAssetAsync(assetName, (asset) => {
//				if (asset == null) {
//					Debug.LogWarning("There is no resource, name : " + assetName);
//					onAfter?.Invoke(null);
//					return;
...
//			AssetMgr.inst.ReleaseAddressable(assetName);
...
//			m_DicAsset.Clear();
//			AssetMgr.inst.ClearAddressable();
...
//									AssetType type, AssetLocation location, bool activeEnable, string bundleName) {
...
//			} else {
//				Object asset = SpawnAsset(assetName, location, bundleName);
//				if (asset == null)
//					return null;
...
//							Vector3 pos, TfInfo rot, TfInfo scale,
//							AssetType type, AssetLocation location) {
//			// 애셋을 먼저 생성한 뒤 반복
//			Object asset = SpawnAsset(assetName, location);
//			if (asset == null)
//				return;
